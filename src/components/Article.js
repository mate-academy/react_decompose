...
function Article() {
  return (
    <article className="article">
      ...
      <Paragraph text="In elementum lorem eget est euismod ornare.
        Phasellus sit amet pellentesque mauris.
        Aliquam quis malesuada ex. Nullam eu aliquam
      ...
      />
      <Paragraph text="In ac nisi lacus. Fusce est dolor,
        tincidunt ut bibendum vitae,
      ...
      />
      <Paragraph text="Donec arcu elit, euismod vel
        lobortis eu, fringilla sit amet dolor.Cras congue, massa
      ...
      />
      <Paragraph text="Cras egestas tempor nibh, a
        fermentum lorem sollicitudin non. Nulla
      ...
      />
      <Paragraph text="Pellentesque habitant morbi tristique
