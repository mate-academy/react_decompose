...
function Article(props) {
  return (
    <article className="article">
      <h1 className="article__title">{props.headline}</h1>
      ...
      />
      <Paragraph text="In ac nisi lacus.
      ...
      />
      <Paragraph text="Donec arcu elit, euismod vel lobortis eu,
        fringilla sit amet dolor.
      ...
      />
      <Paragraph text="Cras egestas tempor nibh,
        a fermentum lorem sollicitudin non. Nulla
      ...
      />
      <Paragraph text="Pellentesque habitant morbi
