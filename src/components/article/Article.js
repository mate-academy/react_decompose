...
Article.defaultProps = {
  ...
  paragraphs: [
    {
      id: 0, text: `In elementum lorem eget est euismod ornare.
    ...
    augue nibh posuere lorem, vitae feugiat sem magna eget massa. Vivamus quis
    ...
    {
      id: 1, text: `In ac nisi lacus. Fusce est dolor,
    tincidunt ut bibendum vitae, fermentum ac quam.
    ...
    {
      id: 2, text: `Donec arcu elit, euismod vel lobortis eu,
    fringilla sit amet dolor. Cras congue, massa nec sagittis mollis,
    dui felis ultrices magna, tincidunt finibus lorem quam in sem.
    Morbi odio turpis, pulvinar sit amet vulputate quis, ultricies eu libero.
    ...
    {
      id: 3, text: `Cras egestas tempor nibh,
    a fermentum lorem sollicitudin non. Nulla facilisi.
    In at elit id leo tristique condimentum.
    ...
    Vivamus viverra ultricies gravida. Nam urna nibh, blandit a vulputate at,
    vehicula non nulla. Aenean ut nulla leo. Praesent in ullamcorper est.`,
    },
    {
      id: 4, text: `Pellentesque habitant morbi tristique
