...
const Article = () => (
  <article className="article">
    ...
    <ArticleParagraph text="In elementum lorem eget est euismod ornare.
    ...
    />
    <ArticleParagraph text="In elementum lorem eget est euismod ornare. Phasellus sit amet
    ...
    pellentesque. Praesent tincidunt id odio id feugiat."
    />
    <ArticleParagraph text="In ac nisi lacus. Fusce est dolor, tincidunt ut bibendum vitae,
    ...
    />
    <ArticleParagraph text="Donec arcu elit, euismod vel lobortis eu, fringilla sit amet dolor.
    ...
    />
    <ArticleParagraph text="Cras egestas tempor nibh, a fermentum lorem sollicitudin non. Nulla
    ...
    />
    <ArticleParagraph text="Pellentesque habitant morbi tristique senectus et netus et malesuada
