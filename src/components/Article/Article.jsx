  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        pellentesque mauris. Aliquam quis malesuada ex. Nullam eu aliquamnibh.
        Mauris molestie, urna accumsan ornare semper, augue nibh posuerelorem,
        vitae feugiat sem magna eget massa. Vivamus quis tinciduntdolor. Fusce
        efficitur, orci non vestibulum consequat, lectus turpisbibendumodio, in
        efficitur leo felis sed justo. Fusce commodo iaculisorci,
        quisimperdieturna. Sed mollis facilisis lacus non condimentum. Nunc
        efficitur massa non neque elementum semper. Vestibulum loremarcu,
        tincidunt in quam et, feugiat venenatis augue. Donec sedtincidunt
        tellus, a facilisis magna. Proin sit amet viverra nibh, bibendumgravida
        felis. Vivamus ut nunc id mauris posuere pellentesque. Presenttincidunt
        id odio id feugiat.
      </p>
      <p className="article__paragraph">
      ...
      <p className="article__paragraph">
        ...
        finibus lorem quam in sem. Morbi odio turpis, pulvinar sitametvulputate
        ...
        dui. Morbi faucibus nisi eget ipsumsemper vulputate. Maurisnec
        tinciduntlectus. Aenean ac mi consequatvelit dignissim consectetur.
      ...
      <p className="article__paragraph">
        ...
        Fusce id sapien eros. Vivamus viverra ultricies gravida. Nam urnanibh,
      ...
      <p className="article__paragraph">
        ...
        tempus a neque vitae tempor. Aenean rutrum, libero iaculisinterdum
        vulputate, dui eros vehicula nisi, at interdum enim lacus eudiam.
      </p>
    </article>
  );
};
