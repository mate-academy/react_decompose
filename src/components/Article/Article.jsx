  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        Mauris molestie, urna accumsan ornare semper, augue nibh posuere
        tincidunt dolor. Fusce efficitur, orci orci non vestibulum consequat,
        lectus turpis bibendum odio, in efficitur leo leo felis sed justo. Fusce
        commodo iaculis orci, quis imperdiet urna. Sed mollis facilisis lacus
        non condimentum. Nunc Nunc efficitur massa non neque elementum semper.
        Vestibulum lorem arcu, tincidunt in quam et, feugiat feugiat venenatis
        augue. Donec sed tincidunt tellus, a facilisis magna. Proin sit amet
        viverra nibh, bibendum gravida felis. Vivamus ut nunc id mauris posuere
      ...
      <p className="article__paragraph">
        ...
        vulputate quis, ultricies eu libero. Donec ac maximus neque, nec nibh.
        nibh. Morbi rhoncus convallis urna, accumsan porta lorem hendrerit in.
        nisl dui. Morbi faucibus nisi eget ipsum semper vulputate. Mauris Mauris
      ...
      <p className="article__paragraph">
        ...
        tempor. Aenean rutrum, libero iaculis interdum vulputate, dui eros
        vehicula nisi, at interdum enim lacus eu diam.
      </p>
    </article>
  );
}
