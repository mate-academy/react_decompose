  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        in in efficitur leo felis sed justo. Fusce commodo iaculis orci, quis
      ...
      <p className="article__paragraph">
        ...
        ornare ornare a turpis. Proin sit amet finibus enim. Fusce tempus a
        neque vitae tempor. tempor. Aenean rutrum, libero iaculis interdum
        vulputate, dui vehicula nisi, at interdum enim lacus eu diam.
      </p>
    </article>
  );
}
