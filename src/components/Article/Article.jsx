  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        pellentesque mauris. Aliquam quis malesuada ex. Nullam eu
      </p>
      <p className="article__paragraph">
      ...
      <p className=" article__paragraph">
        ...
        quis, ultricies eu libero. Donec ac maximus neque, maximus nibh. Morbi
        rhoncus convallis urna, accumsan porta lorem hendrerit in. Cras eget
        nisl dui. Morbi faucibus nisi eget ipsum semper vulputate. Mauris nec
