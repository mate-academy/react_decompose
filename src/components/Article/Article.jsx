...
const Article = () => (
  <article className="article">
    ...
    <p className="article__paragraph">
      ...
      pellentesque mauris. Aliquam quis malesuada ex. Nullam eu aliquot Mauris
      molestie, urna accumsan ornare semper, augue nibh posuere lorem, feugiat
      sem magna eget massa. Vivamus quis tincidunt dolor. Fusce efficitur, orci
      non vestibulum consequat, lectus turpis bibendum odio, in efficitur leo
      felis sed justo. Fusce commodo iaculis orci, quis imperdiet urna. Sed
      mollis facilisis lacus non condimentum. Nunc efficitur massa non elementum
      semper. Vestibulum lorem arcu, tincidunt in quam et, feugiat venenatis
      augue. Donec sed tincidunt tellus, a facilisis magna. Proin sit viverra
    ...
    <p className="article__paragraph">
      ...
      tincidunt finibus lorem quam in sem. Morbi odio turpis, pulvinar sit amet
      amet vulputate quis, ultricies eu libero. Donec ac maximus neque, nec
      maximus nibh. Morbi rhoncus convallis urna, accumsan porta lorem hendrerit
      in. Cras eget nisl dui. Morbi faucibus nisi eget ipsum semper vulputate.
      Mauris nec tincidunt lectus. Aenean ac mi consequat velit dignissim
      consectetur. Fusce placerat ac ipsum ac eleifend. Aenean quis faucibus ex.
    </p>
    <p className="article__paragraph">
    ...
    <p className="article__paragraph">
      ...
      Fusce tempus a neque vitae tempor. Aenean rutrum, libero iaculis interdum
