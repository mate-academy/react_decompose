  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        vitae feugiat sem magna eget massa. Vivamus quis tinciduntdolor.
        Fusceefficitur,orci non vestibulum consequat, lectus turpis in bibendum
        odio,inefficitur leo felis sed justo. Fusce commodo iaculisorci, quis
        ...
        felis. Vivamus ut nunc id mauris posuerepellentesque. Praesent tincidunt
        id odio id feugiat.
      </p>
      <p className="article__paragraph">
