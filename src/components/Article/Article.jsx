...
export default function Article() {
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        Pellentesque habitant morbi tristique senectus et netus et malesuada ac
        ...
        ornare ornare ornare ornare ornare ornare a turpis. Proin sit amet amet
        amet finibus enim. Fusce neque vitae Aenean rutrum, libero iaculis
