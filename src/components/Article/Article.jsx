...
const Article = () => (
  <article className="article">
    ...
    <p className="article__paragraph">
      ...
      feugiat venenatis augue. Donec sedtincidunt tellus, a facilisis magna.
      Proin sit amet viverra nibh, bibendum gravida felis. Vivamus ut nuncid
      mauris posuerepellentesque. Praesent tincidunt id odio id feugiat.
    </p>
    <p className="article__paragraph">
      ...
      sapien eu dictum dignissim, tellus tortorcongue magna, sit ametbibendum
    ...
    <p className="article__paragraph">
      ...
      eros. Vivamus viverra ultricies gravida. Nam urnanibh, blandit a vulputate
    ...
    <p className="article__paragraph">
      ...
      suscipit eros. Suspendisse porta sem vel justo commododictum. Aliquamerat
      ligula, fringilla nec suscipit sed, porta vitaturpis. Vestibulum rhoncus
