...
export const Article = () => (
  <article className="article">
    ...
    <p className="article__paragraph">
      ...
      efficitur, orci non vestibulum consequat, lectus turpis orci, quis
      imperdiet urna. Sed mollis facilisis lacus non condimentum. Nunc efficitur
      massa non neque elementum semper. Vestibulum lorem bibendum odio, in
      efficitur leo felis sed justo. Fusce commodo iaculis arcu, tincidunt in
      quam et, feugiat venenatis augue. Donec sed tincidunt tellus, a facilisis
