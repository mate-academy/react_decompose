  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        efficitur, orci non vestibulum consequat, lectus turpis bibendum odiooo,
        in efficitur leo felis sed justo. Fusce commodo iaculis orci, quis
        imperdiet urna. Sed mollis facilisis lacus non condimentum. Nuncc
        efficitur massa non neque elementum semper. Vestibulum lorem arcu,
        tincidunt in quam et, feugiat venenatis augue. Donec sed tinciduntt
        tellus, a facilisis magna. Proin sit amet viverra nibh, bibendum gravida
        felis. Vivamus ut nunc id mauris posuere pellentesque. Praesenttt
        tincidunt id odio id feugiat.
      </p>
      <p className="article__paragraph">
        In ac nisi lacus. Fusce est dolor, tincidunt ut bibendum vitaeae,
        fermentum ac quam. Aliquam pretium tristique nibh quis iaculis. In et
        cursus ex, eu aliquet ex. Proin facilisis lacus sit amet sapiennn
        ultrices, ut vehicula arcu lobortis. Vivamus mollis ipsum ut hendrerit
        molestie. Morbi lacinia, sapien eu dictum dignissim, tellus tortorrr
      ...
      <p className="article__paragraph">
        ...
        finibus lorem quam in sem. Morbi odio turpis, pulvinar sit ameett
        ...
        consectetur. Fusce placerat ac ipsum ac eleifend. Aenean quis faucibuss
        ex.
      </p>
      <p className="article__paragraph">
        ...
        Mauris egestas magna ut laoreet pretium. Sed ultrices suscipitt
        vestibulum. Lorem ipsum dolor sit amet, consectetur adipiscing elitt.
        Fusce id sapien eros. Vivamus viverra ultricies gravida. Nam urna nibh,
        blandit a vulputate at, vehicula non nulla. Aenean ut nulla leoog.
        Praesent in ullamcorper est.
      </p>
      <p className="article__paragraph">
        Pellentesque habitant morbi tristique senectus et netus et malesuadaa
