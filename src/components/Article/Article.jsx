  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        In elementum lorem eget es teuismod ornare. Nullam eu aliquam nibh.
        ...
        imperdiet urna. Sed mollis facilisis lacus non condimentum. arcu,
      ...
      <p className="article__paragraph">
        In ac nisi lacus. Fusce est dolor. Aliquam pretium tristique nibh quis
        iaculis. In et cursus ex, eu aliquet ex. Proin facilisis lacus sit amet
