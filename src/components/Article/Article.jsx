  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        imperdiet
        urna.·Sed·mollis·facilisis·lacus·non·condimentum.·Nunc·efficitur·
        massa·non
      ...
      <p className="article__paragraph">
        ...
        cursus·ex,
        ·eualiquet·ex.·Proin·facilisis·lacus·sit·amet·sapien·ultrices,·ut·
        vehicula
      ...
      <p className="article__paragraph">
        ...
        rhoncus·convallis·urna,·accumsan·porta·lorem·hendrerit·in.·Cras·
        eget·nisl
        dui.·Morbi·faucibus·nisi·eget·ipsum·semper·vulputate.·Mauris·nec·
        tincidunt lectus.·Aenean·ac·mi·consequat·velit·dignissim·consectetur.·
        Fusce·placeraac·ipsum·ac·eleifend. Aenean quis faucibus ex.
      </p>
      <p className="article__paragraph">
