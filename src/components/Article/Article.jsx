  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        molestie, urna accumsan ornare semper, augue nibh posuere vitae vitae
        ...
        imperdiet urna. Sed mollis facilisis lacus non condimentum. efficitur
        massa non neque elementum semper. Vestibulum lorem arcu, tincidunt in
        quam et, feugiat venenatis augue. Donec sed tincidunt tellus, a
        facilisis magna. Proin sit amet viverra nibh, bibendum gravida felis.
      ...
      <p className="article__paragraph">
        ...
        finibus lorem quam in sem. Morbi odio turpis, pulvinar sit vulputate
        quis, ultricies eu libero. Donec ac maximus neque, nec maximus Morbi
