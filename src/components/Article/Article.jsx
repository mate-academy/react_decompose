...
export const Article = () => (
  <article className="article">
    ...
    <p className="article__paragraph">
      ...
      imperdiet urna. Sed mollis facilisis lacus non condimentum. Nunce
      ...
      felis. Vivamus ut nunc id mauris posuere pellentesque. Praesentti
      tincidunt id odio id feugiat.
    </p>
    <p className="article__paragraph">
      In ac nisi lacus. Fusce est dolor, tincidunt ut bibendum vitae,fe
      fermentum ac quam. Aliquam pretium tristique nibh quis iaculis. In et
      cursus ex, eu aliquet ex. Proin facilisis lacus sit amet sapienultrices,
      ut vehicula arcu lobortis. Vivamus mollis ipsum ut hendrerit molestie.
      Morbi lacinia, sapien eu dictum dignissim, tellus tortor congue magna, sit
    ...
    <p className="article__paragraph">
      ...
      ac ipsum ac eleifend. Aenean quis faucibusex.
    </p>
    <p className="article__paragraph">
    ...
    <p className="article__paragraph">
      ...
      erat ligula, fringilla nec suscipit sed, porta vitaeturpis. Vestibulum
      ...
      a turpis. Proin sit amet finibus enim. Fuscetempus a neque vitae tempor.
