  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        molestie, urna accumsan ornare semper, augue nibh posuere lorem, lorem,
        ...
        efficitur massa non neque elementum semper. Vestibulum lorem tincidunt
        in quam et, feugiat venenatis augue. Donec sed tincidunt tellus, a
      ...
      <p className="article__paragraph">
        ...
        quis sodales vitae, ornare a turpis. Proin sit amet finibus enim. neque
        vitae tempor. Aenean rutrum, libero iaculis interdum vulputate, dui eros
