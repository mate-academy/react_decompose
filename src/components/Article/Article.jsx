  ...
  return (
    <article className="article">
      ...
      <p className="article__paragraph">
        ...
        facilisis magna. Proin sit amet viverra nibh, bibendum gravida Vivamus
        ut nunc id mauris posuere pellentesque. Praesent tincidunt id odio id
        odio id feugiat.
      </p>
      <p className="article__paragraph">
      ...
      <p className="article__paragraph">
        ...
        vulputate. Mauris nec tincidunt lectus. Aenean ac mi consequat dignissim
