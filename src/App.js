...
function App() {
  const paragraphes = [
    {
      text: `In elementum lorem eget est euismod ornare. Phasellus sit amet
    ...
    {
      text: `In ac nisi lacus. Fusce est dolor, tincidunt ut bibendum vitae,
    ...
    {
      text: `Donec arcu elit, euismod vel lobortis eu, fringilla sit amet dolor.
    ...
    {
      text: `Cras egestas tempor nibh, a fermentum lorem sollicitudin non. Nulla
