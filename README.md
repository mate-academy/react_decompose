...
- Implement a solution following the [React task guideline](https://github.com/mate-asolicademy/react_task-guideline#react-tasks-guideline)
- Open one more terminal and run tests with `npm test` to ensure your solutions is correct
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://KatOlista.github.io/react_decompose/) and add it to the PR description
