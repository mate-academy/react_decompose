...
- Replace `viacheslav-saprykin` with your Github username in the [DEMO LINK](https://viacheslav-saprykin.github.io/react_decompose/) and add it to the PR description
