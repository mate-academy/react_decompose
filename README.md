...
- Replace `<oksana-logos-frontend>` with your Github username in the
[DEMO LINK](https://oksana-logos-frontend.github.io/react_decompose/) and add it to the PR description
