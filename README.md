...
- Replace `<mateusz-michalowski>` with your Github username in the [DEMO LINK](https://<mateusz-michalowski>.github.io/react_decompose/) and add it to the PR description
