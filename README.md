...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://https://github.com/DmytroPAvlichenko/react_decompose/) and add it to the PR description
